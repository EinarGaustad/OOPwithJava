...
public class BaseSpaceObject extends Polygon {
	...
	/**
	 * Returns the position of the center of this Polygon. The
	 * asParentCoordinates determines if the position is transformed into the
	 * parent coordinate system.
	 * 
	 * @param asParentCoordinates
	 *            determines if the position is transformed into the parent
	 *            coordinate system
...
// (bounds.getMaxY() + bounds.getMaxY() / 2));
// if (asParentCoordinates) {
// center = localToParent(center);
// }
// return center;
