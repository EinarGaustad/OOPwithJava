...
import oving9.abstractAccount.SavingsAccount;
...
public class SavingsAccountTest extends TestCase {
    ...
    public void testWithdraw() {
        ...
        try {
            ...
            assertTrue(
                    "IllegalStateException should be thrown after withdraw(4930.0)",
                    e_2 instanceof IllegalStateException);
        }
        _test__withdraw_transitions7_effect_state(sub);
        
    }
    
    private void _test__deposit_transitions0_source_state(
            final SavingsAccount it) {
    ...
    private void _test__deposit_transitions0_effect_state(
            final SavingsAccount it) {
    ...
    private void _test__deposit_transitions2_effect_state(
            final SavingsAccount it) {
    ...
    private void _test__withdraw_transitions4_effect_state(
            final SavingsAccount it) {
        _test__withdraw_transitions4_effect_state_objectTests0_test(sub);
        
    }
    
    private void _test__withdraw_transitions4_effect_state_objectTests0_test(
            final SavingsAccount it) {
    ...
    private void _transition_exprAction__withdraw_transitions5_actions0(
            final SavingsAccount it) {
        try {
    ...
    private void _test__withdraw_transitions5_effect_state_objectTests0_test(
        ...
        double _balance = it.getBalance();
        assertEquals("getBalance() == 4950.0 failed after withdraw(10000.0)",
                4950.0, _balance);
        
    }
    
    private void _transition_exprAction__withdraw_transitions6_actions0(
            final SavingsAccount it) {
        try {
    ...
    private void _test__withdraw_transitions7_effect_state(
            final SavingsAccount it) {
        _test__withdraw_transitions7_effect_state_objectTests0_test(sub);
        
    }
    
    private void _test__withdraw_transitions7_effect_state_objectTests0_test(
            final SavingsAccount it) {
