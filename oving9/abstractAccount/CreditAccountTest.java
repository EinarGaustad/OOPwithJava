...
import oving9.abstractAccount.CreditAccount;
...
public class CreditAccountTest extends TestCase {
    ...
    public void testDeposit() {
        ...
        try {
            ...
            assertTrue(
                    "IllegalArgumentException should be thrown after deposit(-10000.0)",
    ...
    public void testWithdraw() {
        ...
        try {
            ...
            assertTrue(
                    "IllegalArgumentException should be thrown after withdraw(-10000.0)",
                    e instanceof IllegalArgumentException);
        }
        ...
        try {
            ...
            assertTrue(
                    "IllegalStateException should be thrown after withdraw(20000.0)",
                    e_1 instanceof IllegalStateException);
        }
    ...
    public void testSetCreditLine() {
        ...
        try {
            ...
            assertTrue(
                    "IllegalArgumentException should be thrown after setCreditLine(-5000.0)",
                    e instanceof IllegalArgumentException);
        }
        ...
        try {
            ...
            assertTrue(
                    "IllegalStateException should be thrown after withdraw(4000.0), setCreditLine(3000.0)",
                    e_1 instanceof IllegalStateException);
        }
    ...
    private void _test__deposit_transitions0_source_state_objectTests0_test(
            final CreditAccount it) {
        
        double _balance = it.getBalance();
        assertEquals("getBalance() == 0.0 failed after deposit(10000.0)", 0.0,
                _balance);
        
    }
    
    private void _transition_exprAction__deposit_transitions0_actions0(
            final CreditAccount it) {
        try {
    ...
    private void _test__deposit_transitions0_effect_state_objectTests0_test(
            final CreditAccount it) {
        
        double _balance = it.getBalance();
        assertEquals("getBalance() == 10000.0 failed after deposit(10000.0)",
                10000.0, _balance);
        
    }
    
    private void _transition_exprAction__deposit_transitions1_actions0(
            final CreditAccount it) {
        try {
    ...
    private void _test__deposit_transitions2_effect_state_objectTests0_test(
            final CreditAccount it) {
    ...
    private void _transition_exprAction__withdraw_transitions0_actions0(
            final CreditAccount it) {
        try {
    ...
    private void _transition_exprAction__withdraw_transitions0_actions1(
            final CreditAccount it) {
        try {
    ...
    private void _test__withdraw_transitions0_effect_state(
            final CreditAccount it) {
        _test__withdraw_transitions0_effect_state_objectTests0_test(sub);
        
    }
    
    private void _test__withdraw_transitions0_effect_state_objectTests0_test(
            final CreditAccount it) {
        
        double _balance = it.getBalance();
        assertEquals(
                "getBalance() == 15000.0 failed after deposit(20000.0) ,withdraw(5000.0)",
                15000.0, _balance);
        
    }
    
    private void _transition_exprAction__withdraw_transitions1_actions0(
            final CreditAccount it) {
        try {
    ...
    private void _test__withdraw_transitions2_effect_state(
            final CreditAccount it) {
        _test__withdraw_transitions2_effect_state_objectTests0_test(sub);
        
    }
    
    private void _test__withdraw_transitions2_effect_state_objectTests0_test(
            final CreditAccount it) {
    ...
    private void _transition_exprAction__withdraw_transitions3_actions0(
            final CreditAccount it) {
        try {
    ...
    private void _test__withdraw_transitions3_effect_state(
            final CreditAccount it) {
        _test__withdraw_transitions3_effect_state_objectTests0_test(sub);
        
    }
    
    private void _test__withdraw_transitions3_effect_state_objectTests0_test(
            final CreditAccount it) {
        
        double _minus = (-5000.0);
        double _balance = it.getBalance();
        assertEquals("getBalance() == -5000.0 failed after withdraw(20000.0)",
                _minus, _balance);
        
    }
    
    private void _transition_exprAction__withdraw_transitions4_actions0(
            final CreditAccount it) {
        try {
    ...
    private void _test__withdraw_transitions5_effect_state(
            final CreditAccount it) {
        _test__withdraw_transitions5_effect_state_objectTests0_test(sub);
        
    }
    
    private void _test__withdraw_transitions5_effect_state_objectTests0_test(
            final CreditAccount it) {
    ...
    private void _test__setCreditLine_transitions0_source_state(
            final CreditAccount it) {
        _test__setCreditLine_transitions0_source_state_objectTests0_test(sub);
        
    }
    
    private void _test__setCreditLine_transitions0_source_state_objectTests0_test(
            final CreditAccount it) {
        
        double _creditLine = it.getCreditLine();
        assertEquals(
                "getCreditLine() == 10000.0 failed after setCreditLine(5000.0)",
                10000.0, _creditLine);
        
    }
    
    private void _transition_exprAction__setCreditLine_transitions0_actions0(
            final CreditAccount it) {
        try {
    ...
    private void _test__setCreditLine_transitions0_effect_state(
            final CreditAccount it) {
        _test__setCreditLine_transitions0_effect_state_objectTests0_test(sub);
        
    }
    
    private void _test__setCreditLine_transitions0_effect_state_objectTests0_test(
            final CreditAccount it) {
        
        double _creditLine = it.getCreditLine();
        assertEquals(
                "getCreditLine() == 5000.0 failed after setCreditLine(5000.0)",
                5000.0, _creditLine);
        
    }
    
    private void _transition_exprAction__setCreditLine_transitions1_actions0(
            final CreditAccount it) {
        try {
    ...
    private void _test__setCreditLine_transitions2_effect_state(
            final CreditAccount it) {
        _test__setCreditLine_transitions2_effect_state_objectTests0_test(sub);
        
    }
    
    private void _test__setCreditLine_transitions2_effect_state_objectTests0_test(
            final CreditAccount it) {
    ...
    private void _transition_exprAction__setCreditLine_transitions3_actions0(
            final CreditAccount it) {
        try {
    ...
    private void _transition_exprAction__setCreditLine_transitions3_actions1(
            final CreditAccount it) {
        try {
    ...
    private void _test__setCreditLine_transitions4_effect_state(
            final CreditAccount it) {
        _test__setCreditLine_transitions4_effect_state_objectTests0_test(sub);
        
    }
    
    private void _test__setCreditLine_transitions4_effect_state_objectTests0_test(
            final CreditAccount it) {
