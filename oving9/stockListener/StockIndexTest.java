...
import oving9.stockListener.StockIndex;
...
public class StockIndexTest extends TestCase {
    ...
    public void testChangePrice() {
        ...
        _transition_exprAction__changePrice_transitions0_actions0(
                facebookPrice2, facebookPrice3);
        _test__changePrice_transitions0_effect_state(facebookPrice2,
                facebookPrice3);
        _transition_exprAction__changePrice_transitions1_actions0(
                facebookPrice2, facebookPrice3);
        _test__changePrice_transitions1_effect_state(facebookPrice2,
                facebookPrice3);
    ...
    private void _test__constructor_transitions0_effect_state_objectTests1_test(
            final StockIndex it) {
    ...
    private void _test__constructor_transitions0_effect_state_objectTests2_test(
            final StockIndex it) {
    ...
    private void _test__addStock_transitions0_effect_state_objectTests0_test(
        ...
        boolean _equals = this.operator_equals(_index, this.facebookPrice);
        assertTrue(
                "index == facebookPrice failed after index0.addStock(facebook)",
                _equals);
    ...
    private void _test__removeStock_transitions0_effect_state_objectTests0_test(
        ...
        boolean _equals = this.operator_equals(_index, this.facebookPrice);
        assertTrue(
                "index == facebookPrice failed after indexN.removeStock(apple)",
                _equals);
    ...
    private void _test__removeStock_transitions2_effect_state_objectTests0_test(
            final StockIndex it) {
        
        double _index = it.getIndex();
        boolean _equals = this.operator_equals(_index, 0.0);
        assertTrue("index == 0.0 failed after indexN.removeStock(facebook)",
                _equals);
    ...
    private void _transition_exprAction__changePrice_transitions0_actions0(
            final double facebookPrice2, final double facebookPrice3) {
        try {
            
            this.facebook.setPrice(facebookPrice2);
        } catch (junit.framework.AssertionFailedError error) {
            fail("facebook.setPrice(facebookPrice2) failed: "
                    + error.getMessage());
        }
    ...
    private void _test__changePrice_transitions0_effect_state(
            final double facebookPrice2, final double facebookPrice3) {
        _test__changePrice_transitions0_effect_state_objectTests0_test(index1,
                facebookPrice2, facebookPrice3);
        _test__changePrice_transitions0_effect_state_objectTests1_test(indexN,
                facebookPrice2, facebookPrice3);
        
    }
    
    private void _test__changePrice_transitions0_effect_state_objectTests0_test(
            final StockIndex it, final double facebookPrice2,
            final double facebookPrice3) {
        
        double _index = it.getIndex();
        boolean _equals = this.operator_equals(_index, facebookPrice2);
        assertTrue(
                "index == facebookPrice2 failed after facebook.setPrice(facebookPrice2)",
                _equals);
        
    }
    
    private void _test__changePrice_transitions0_effect_state_objectTests1_test(
            final StockIndex it, final double facebookPrice2,
            final double facebookPrice3) {
        ...
        boolean _equals = this.operator_equals(_index, _plus);
        assertTrue(
                "index == facebookPrice2 + applePrice failed after facebook.setPrice(facebookPrice2)",
                _equals);
    ...
    private void _transition_exprAction__changePrice_transitions1_actions0(
        ...
        try {
            ...
            fail("facebook.setPrice(facebookPrice3) failed: "
                    + error.getMessage());
        }
    ...
    private void _test__changePrice_transitions1_effect_state(
            final double facebookPrice2, final double facebookPrice3) {
        _test__changePrice_transitions1_effect_state_objectTests0_test(index1,
                facebookPrice2, facebookPrice3);
        _test__changePrice_transitions1_effect_state_objectTests1_test(indexN,
                facebookPrice2, facebookPrice3);
    ...
    private void _test__changePrice_transitions1_effect_state_objectTests0_test(
        ...
        assertTrue(
                "index == facebookPrice3 failed after facebook.setPrice(facebookPrice3)",
                _equals);
        
    }
    
    private void _test__changePrice_transitions1_effect_state_objectTests1_test(
            final StockIndex it, final double facebookPrice2,
            final double facebookPrice3) {
        ...
        boolean _equals = this.operator_equals(_index, _plus);
        assertTrue(
                "index == facebookPrice3 + applePrice failed after facebook.setPrice(facebookPrice3)",
                _equals);
