...
import oving9.stockListener.SmartStock;
import oving9.stockListener.Stock;
import oving9.stockListener.StockListener;
...
public class SmartStockTest extends TestCase {
    ...
    private void setPrice1(final double newPrice,
            final double expectedOldPrice, final double expectedNewPrice) {
        this.oldPrice1 = this.newPrice1;
        this.newPrice1 = newPrice;
        this.stock.setPrice(newPrice);
        Assert.assertEquals(Double.valueOf(expectedOldPrice),
                Double.valueOf(this.oldPrice2));
        Assert.assertEquals(Double.valueOf(expectedNewPrice),
                Double.valueOf(this.newPrice2));
    }
    ...
    private void _test__constructor_transitions0_effect_state_objectTests0_test(
            final SmartStock it) {
    ...
    private void _transition_exprAction__stockListener_transitions0_actions0() {
        try {
            ...
            final StockListener _function = new StockListener() {
                ...
                public void stockPriceChanged(final Stock stock,
                        final double oldPrice, final double newPrice) {
                    SmartStockTest.this.setPrice2(oldPrice, newPrice);
                }
            };
            this.stock.addStockListener(_function);
        } catch (junit.framework.AssertionFailedError error) {
            fail("stock.addStockListener([Stock stock, double oldPrice, double newPrice | setPrice2(oldPrice, newPrice) ]) failed: "
                    + error.getMessage());
        }
    ...
    private void _transition_exprAction__stockListener_transitions0_actions1() {
        try {
            ...
            fail("setPrice1(118.0d, 110.0d, 118.0d) failed: "
                    + error.getMessage());
        }
    ...
    private void _test__stockListener_transitions0_effect_state_objectTests0_test(
            final SmartStock it) {
        
        double _price = it.getPrice();
        assertEquals(
                "price == 118.0d failed after stock.addStockListener([Stock stock, double oldPrice, double newPrice | setPrice2(oldPrice, newPrice) ]) ,setPrice1(118.0d, 110.0d, 118.0d)",
                118.0d, _price);
    ...
    private void _transition_exprAction__stockListener_transitions1_actions0() {
        try {
            ...
            fail("setPrice1(121.0d, 118.0d, 121.0d) failed: "
                    + error.getMessage());
        }
    ...
    private void _test__stockListener_transitions1_effect_state_objectTests0_test(
            final SmartStock it) {
        
        double _price = it.getPrice();
        assertEquals(
                "price == 121.0d failed after setPrice1(121.0d, 118.0d, 121.0d)",
                121.0d, _price);
    ...
    private void _transition_exprAction__intervalListener1_transitions0_actions0() {
        try {
            ...
            fail("stock.addStockListener([Stock stock, double oldPrice, double newPrice | setPrice2(oldPrice, newPrice) ], 110.0d, 120.0d) failed: "
                    + error.getMessage());
        }
    ...
    private void _test__intervalListener1_transitions0_effect_state_objectTests0_test(
            final SmartStock it) {
        
        double _price = it.getPrice();
        assertEquals(
                "price == 118.0d failed after stock.addStockListener([Stock stock, double oldPrice, double newPrice | setPrice2(oldPrice, newPrice) ], 110.0d, 120.0d) ,setPrice1(118.0d, 0.0d, 0.0d)",
                118.0d, _price);
    ...
    private void _test__intervalListener1_transitions1_effect_state_objectTests0_test(
            final SmartStock it) {
    ...
    private void _transition_exprAction__intervalListener2_transitions0_actions1() {
        try {
            ...
            fail("setPrice1(108.0d, 110.0d, 108.0d) failed: "
                    + error.getMessage());
        }
    ...
    private void _test__intervalListener2_transitions0_effect_state_objectTests0_test(
            final SmartStock it) {
        
        double _price = it.getPrice();
        assertEquals(
                "price == 108.0d failed after stock.addStockListener([Stock stock, double oldPrice, double newPrice | setPrice2(oldPrice, newPrice) ], 110.0d, 120.0d) ,setPrice1(108.0d, 110.0d, 108.0d)",
                108.0d, _price);
    ...
    private void _transition_exprAction__intervalListener2_transitions1_actions0() {
        try {
            ...
            fail("setPrice1(115.0d, 110.0d, 108.0d) failed: "
                    + error.getMessage());
        }
    ...
    private void _test__intervalListener2_transitions1_effect_state_objectTests0_test(
            final SmartStock it) {
        
        double _price = it.getPrice();
        assertEquals(
                "price == 115.0d failed after setPrice1(115.0d, 110.0d, 108.0d)",
                115.0d, _price);
    ...
    private void _transition_exprAction__differenceListener1_transitions0_actions0() {
        try {
            ...
            fail("stock.addStockListener([Stock stock, double oldPrice, double newPrice | setPrice2(oldPrice, newPrice) ], 10.0d) failed: "
                    + error.getMessage());
        }
    ...
    private void _test__differenceListener1_transitions0_effect_state_objectTests0_test(
            final SmartStock it) {
        
        double _price = it.getPrice();
        assertEquals(
                "price == 118.0d failed after stock.addStockListener([Stock stock, double oldPrice, double newPrice | setPrice2(oldPrice, newPrice) ], 10.0d) ,setPrice1(118.0d, 0.0d, 0.0d)",
                118.0d, _price);
    ...
    private void _transition_exprAction__differenceListener1_transitions1_actions0() {
        try {
            ...
            fail("setPrice1(121.0d, 110.0d, 121.0d) failed: "
                    + error.getMessage());
        }
    ...
    private void _test__differenceListener1_transitions1_effect_state_objectTests0_test(
            final SmartStock it) {
        
        double _price = it.getPrice();
        assertEquals(
                "price == 121.0d failed after setPrice1(121.0d, 110.0d, 121.0d)",
                121.0d, _price);
    ...
    private void _transition_exprAction__differenceListener2_transitions0_actions0() {
        try {
            ...
            fail("stock.addStockListener([Stock stock, double oldPrice, double newPrice | setPrice2(oldPrice, newPrice) ], 5.0d) failed: "
                    + error.getMessage());
        }
    ...
    private void _test__differenceListener2_transitions0_effect_state_objectTests0_test(
            final SmartStock it) {
        
        double _price = it.getPrice();
        assertEquals(
                "price == 118.0d failed after stock.addStockListener([Stock stock, double oldPrice, double newPrice | setPrice2(oldPrice, newPrice) ], 5.0d) ,setPrice1(118.0d, 110.0d, 118.0d)",
                118.0d, _price);
    ...
    private void _transition_exprAction__differenceListener2_transitions1_actions0() {
        try {
            ...
            fail("setPrice1(121.0d, 110.0d, 118.0d) failed: "
                    + error.getMessage());
        }
    ...
    private void _test__differenceListener2_transitions1_effect_state_objectTests0_test(
            final SmartStock it) {
        
        double _price = it.getPrice();
        assertEquals(
                "price == 121.0d failed after setPrice1(121.0d, 110.0d, 118.0d)",
                121.0d, _price);
