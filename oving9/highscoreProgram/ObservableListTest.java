...
import oving9.highscoreProgram.ListListener;
import oving9.highscoreProgram.ObservableList;
...
public class ObservableListTest extends TestCase {
    ...
    private void testElements(final int... elements) {
        ...
        final Iterator<Integer> iterator = ((List<Integer>) Conversions
                .doWrapArray(elements)).iterator();
        int i = 0;
    ...
    public void testAcceptsElement() {
        ...
        try {
            ...
            assertTrue(
                    "IllegalArgumentException should be thrown after observableList.addElement(\"5\")",
    ...
    private void _test__acceptsElement_transitions0_effect_state_objectTests0_test(
            final ObservableList it) {
    ...
    private void _transition_exprAction__acceptsElement_transitions1_actions0() {
        try {
            ...
            fail("observableList.addElement(\"5\") failed: "
                    + error.getMessage());
        }
    ...
    private void _test__addElement_transitions0_effect_state_objectTests0_test() {
        try {
            ...
            fail("testElements(5) failed after observableList.addElement(5): "
                    + error.getMessage());
        }
    ...
    private void _test__addElement_transitions1_effect_state_objectTests0_test() {
        try {
            ...
            fail("testElements(5, 6) failed after observableList.addElement(6): "
                    + error.getMessage());
        }
    ...
    private void _transition_exprAction__addElement_transitions2_actions0() {
        try {
            ...
            fail("observableList.addElement(0, 2) failed: "
                    + error.getMessage());
        }
    ...
    private void _test__addElement_transitions2_effect_state_objectTests0_test() {
        try {
            ...
            fail("testElements(2, 5, 6) failed after observableList.addElement(0, 2): "
                    + error.getMessage());
        }
    ...
    private void _transition_exprAction__listListener_transitions0_actions0() {
        try {
            ...
            fail("observableList.addListListener([list, pos | pos2 = pos]) failed: "
                    + error.getMessage());
        }
    ...
    private void _test__listListener_transitions0_effect_state_objectTests0_test() {
        try {
            ...
            fail("testElements(5) failed after observableList.addListListener([list, pos | pos2 = pos]) ,addElement(5, 0): "
                    + error.getMessage());
        }
    ...
    private void _test__listListener_transitions1_effect_state_objectTests0_test() {
        try {
            ...
            fail("testElements(5, 6) failed after addElement(6, 1): "
                    + error.getMessage());
        }
    ...
    private void _test__listListener_transitions2_effect_state_objectTests0_test() {
        try {
            ...
            fail("testElements(2, 5, 6) failed after addElement(2, 0): "
                    + error.getMessage());
        }
