...
//			int compare = named1.getFamilyName().compareTo(named2.getFamilyName());
//			if ( compare > 0){//returnere et negativt heltall om det første etternavnet er alfabetisk ordnet før det andre,
//				return -1;
//			}
...
//			}
//		}
//		else {//Dersom etternavnene er like skal metoden gjøre det samme på fornavnene
